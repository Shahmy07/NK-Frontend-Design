...
import { Button, Form, Select, Space, message, Upload, } from 'antd';
                    ...
                    <Col lg="6" className='mt-2'>
                        ...
                        <Row className='border border-3 mt-4 border-primary-subtle rounded pb-5 pt-3 mx-0'>
                            <Col xl="12" className='mt-4 text-center'>
                                <div className='fontsize22px fw-bold mb-3'>
                                    Upload Video
                                </div>
                                <Upload {...props}>
                                    <Button icon={<UploadOutlined />}>Click to Upload</Button>
...
export default FormEquipmentMain;